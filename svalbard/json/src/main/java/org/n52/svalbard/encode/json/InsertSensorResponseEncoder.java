 ...
 * @since 1.0.0
 */
public class InsertSensorResponseEncoder extends AbstractSosResponseEncoder<InsertSensorResponse> {
    public InsertSensorResponseEncoder() {
        super(InsertSensorResponse.class, Sos2Constants.Operations.InsertSensor);
    }
