 ...
 * are specific to OGC OGC SOS 1.0.0.0
 *
 * @since 1.0.0
 */
public interface Sos1Constants extends SosConstants {
    ...
    /**
     * enum with names of OGC SOS 1.0.0 Capabilities sections not supported by all versions
     */
    ...
    /**
     * enum with parameter names for OGC SOS 1.0.0 getObservation request not supported by all versions
     */
    ...
    /**
     * enum with parameter names for OGC SOS 1.0.0 insertObservation request not supported by all versions
     */
    ...
    /**
     * enum with parameter names for OGC SOS 1.0.0 getFeatureOfInterest request not supported by all versions
     */
    ...
    /**
     * enum with parameter names for OGC SOS 1.0.0 getObservationById request not supported by all versions
     */
